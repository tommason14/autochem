...
store the iteration number.
	...
	def read(self):
        """Memory-efficient reading of large log files, using a generator returning lines as
        required"""
...
################################
    ...
    def get_non_fmo(self):
        """Returns energy of the calculation, with the exact definition dependent on the input file
parameters. Non-FMO energy"""
