...
class Atom:
    ...
    * ``mol`` -- molecule this atom is a part of
    ...
    * ``symbol`` -- read or write the atom symbol directly
    ...
    def matrix(self, matrix):
        """Rotate this atom by a rotation matrix, given either as a one or two dimensional list containing 9 elements to create a 3x3 matrix. Can use a list, numpy array or tuple"""
